...
int main (int argc, char* argv[])
{
   ...
   Population pop(100, 100, "run-log.txt", &symConfig);
   string s1;
   ...
   //Set the selection operator to be roulette wheel selection
   symConfig.selectionOperator = new Selection();
   //Set the parsimony pressure class to Limit, limits the size to 200
   ...
   //Set the initial depth limit of the population. Must be initialised after
   // the depth Limit
